                ...
                children: [
                  Text(
                    ...
                    style: theme.textTheme.bodySmall?.copyWith(
                      color: project.isOverdue ? cs.error : cs.onSurfaceVariant,
                ...
                if (project.costDifference != null)
                  Expanded(
                    child: _LabeledIconValue(
                      label: "Budget Diff",
                      value: "+€${project.costDifference!.toStringAsFixed(0)}",
                      icon: project.costDifferenceIcon,
                      color: project.costDifferenceColor ?? cs.onSurfaceVariant,
                    ),
                  ),
              ],
            ),
